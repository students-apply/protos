...
func (x *OAuthRequest) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *OAuthRequest) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x60, 0x0a, 0x0c, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x52,
	...
	0x6c, 0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xe1, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74,
	...
	0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x05, 0x4f, 0x41,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xb1, 0x01, 0x0a,
	0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x28, 0x0a, 0x07,
	0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x11, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x55,
	...
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x12, 0x45, 0x0a, 0x0c, 0x55, 0x70, 0x6c,
	...
	0x6f, 0x74, 0x6f, 0x73, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_auth_auth_proto_goTypes = []interface{}{
	...
	(*OAuthRequest)(nil),          // 10: auth.OAuthRequest
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	10, // 4: auth.AuthService.OAuth:input_type -> auth.OAuthRequest
	7,  // 5: auth.UserService.GetUser:input_type -> auth.UserRequest
	6,  // 6: auth.UserService.UpdateUser:input_type -> auth.UpdateUserRequest
	8,  // 7: auth.UserService.UploadAvatar:input_type -> auth.UploadAvatarRequest
	1,  // 8: auth.AuthService.SignUp:output_type -> auth.SignUpResponse
	4,  // 9: auth.AuthService.SignIn:output_type -> auth.TokenResponse
	4,  // 10: auth.AuthService.RefreshToken:output_type -> auth.TokenResponse
	4,  // 11: auth.AuthService.OAuth:output_type -> auth.TokenResponse
	5,  // 12: auth.UserService.GetUser:output_type -> auth.User
	5,  // 13: auth.UserService.UpdateUser:output_type -> auth.User
	9,  // 14: auth.UserService.UploadAvatar:output_type -> auth.UploadAvatarResponse
